//Le falta confirmación de tipos a este programa para ser perfecto
...
int main() {
        ...
        cout << "\nEl precio final total a pagar por " << countTickets << " entradas es de: $" << fixed << setprecision(2) << modifiedTicketCost * countTickets << endl << endl;
